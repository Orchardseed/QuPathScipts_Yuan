...
def cellpose = Cellpose2D.builder(pathModel)
        ...
        .tileSize(8000)                // If your GPU can take it, make larger tiles to process fewer of them. Useful for Omnipose
...
def nuc_area_measurement= 'Area µm^2' // If cellExpansion(4.0) function wasn't used in StarDist model, please use 'Area µm^2'
...
PathClassifierTools.setIntensityClassifications(detObjects, "DAB: Mean", threshold) // If cellExpansion(4.0) function wasn't used in StarDist model, please use "DAB: Mean"

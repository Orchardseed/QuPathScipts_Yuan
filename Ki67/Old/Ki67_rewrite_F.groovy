...
QP.setColorDeconvolutionStains('{"Name" : "H-DAB modified", "Stain 1" : "Hematoxylin", "Values 1" : "0.81349098 0.57214624 0.10431251", "Stain 2" : "DAB", "Values 2" : "0.1675769  0.3998422  0.90113495", "Background" : " 255 255 255"}')
...
//def objects = removeObjects(toDelete, true)
//objects
...
// cell classification
runObjectClassifier('Celltypes classifier_final')
...
createAnnotationsFromDensityMap("Tumor_bed_area_250", [0: 50.0], "Tumor Bed Predicted")
...
findDensityMapHotspots("Ki67+ Tumor Cells Hotspot", 0, 6, 250.000000, true, false)

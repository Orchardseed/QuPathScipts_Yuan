...
def pathModel = 'D:\\QuPath\\Cellpose_models_retrained_Yuan\\cyto_retrained'
...
//        .normalizePercentilesGlobal(0.1, 99.8, 10) // Convenience global percentile normalization. arguments are percentileMin, percentileMax, dowsample.
        ...
        .learningRate(0.1)        // Optional: Will default to 0.2
        .batchSize(16)             // Optional: Will default to 8
        .modelDirectory(new File("D:\\QuPath\\QuPath projects\\BIF\\yg.bif\\Script\\HER2")) // Optional place to store resulting model. Will default to QuPath project root, and make a 'models' folder
        .build()
